...
const DancingEmoji = ({ emoji, index }) => {
  ...
  return (
    <motion.span
      ...
      animate={isMobile ? { opacity: 0.6, scale: 1, rotate: 0 } : {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 text-center flex flex-col items-center max-w-5xl px-6">
        ...
        <div className="relative flex items-center justify-center mb-16 md:mb-20 scale-75 sm:scale-90 md:scale-100 transition-transform">
          <PulseRing delay={0} size={window?.innerWidth > 768 ? 420 : 260} />
          <PulseRing delay={0.5} size={window?.innerWidth > 768 ? 500 : 310} />
          <PulseRing delay={1} size={window?.innerWidth > 768 ? 580 : 360} />
          ...
          <motion.div
            ...
            className="relative z-20 w-40 h-40 sm:w-48 sm:h-48 md:w-80 md:h-80 rounded-[3rem] md:rounded-[4rem] border-[6px] md:border-[8px] border-white p-1.5 md:p-2 bg-white/40 backdrop-blur-3xl shadow-[0_40px_80px_-15px_rgba(0,0,0,0.15)] overflow-hidden rotate-2"
          >
            <img
              src={pfp}
              alt="Thank You"
        ...
        <div className="space-y-8 max-w-4xl">
          ...
          >
            ...
            <h1 className="text-4xl sm:text-5xl md:text-8xl lg:text-9xl font-black text-slate-900 tracking-tighter leading-[1.1] md:leading-[0.85] mb-6 md:mb-8 break-words">
            ...
            <p className="text-base sm:text-lg md:text-2xl text-slate-500 font-medium tracking-normal max-w-2xl mx-auto leading-relaxed opacity-90 px-4">
